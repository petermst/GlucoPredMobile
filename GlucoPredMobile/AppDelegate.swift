...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    var enableLandscapeInGraph = false
    
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        initializeRealm()
        let navigCOntr = self.window?.rootViewController as! UINavigationController
        let mainMenuVC = navigCOntr.viewControllers.first as! MainMenuViewController
        mainMenuVC.currentSim = SimulationResult()
        return true
    }
